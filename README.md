...
- Language: English and Japanese. Default is Auto (browser); switch in Options → Language.

### Chrome Web Store Prep

- Short description: see `store/listing-en.md` (≤132 chars)
- Full description: see `store/listing-en.md`
- Privacy Policy: see `store/privacy-policy.md`
- Permissions justification: see `store/permissions-justification.md`
- Assets checklist: see `store/asset-checklist.md` (screenshots, icon)
- Release notes: `store/release-notes/0.1.1.md`

How to publish (summary)

- Create a Chrome Web Store developer account and a new item
- Upload the ZIP of this folder (ensure `manifest.json` version is updated)
- Fill in listing fields with the English content above
- Upload at least one screenshot (1280×800 recommended) and the 128×128 icon
- Provide the Privacy Policy URL content (can be a GitHub Pages link or repository file URL)
- Submit for review
...
- Switch UI language under Options → Language (Auto/English/Japanese).
...
- 言語：英語/日本語に対応。初期値は「自動（ブラウザ）」。オプション → 言語 から切替可能。
...
- UI 言語は「オプション → 言語」で英語/日本語/自動（ブラウザ言語）から選択できます（初期値は英語）。
